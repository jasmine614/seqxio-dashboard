      ...
      <main className="flex-1 flex flex-col gap-4 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <button className="px-5 py-4 bg-gradient-primary text-white rounded-[25px] font-medium flex items-center gap-2 hover:opacity-90 transition-opacity">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14 8H8V14H6V8H0V6H6V0H8V6H14V8Z" fill="white"/>
              </svg>
              Add Project
            </button>
            <button className="px-5 py-4 border border-[#155234] text-[#155234] rounded-[25px] font-medium hover:bg-gray-50 transition-colors">
              Import Data
            </button>
          </div>
